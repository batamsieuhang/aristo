...
public class OperatorAssignCS {
    ...
    public OperatorAssignCS(Operator op, int threads, Map<String, Integer> threadMap, double dinput, Cluster cluster) throws Exception{
        name = op.getName();
    ...
    public OperatorAssignCS(Operator op, int threads, Map<String, Integer> threadMap, Cluster cluster) throws Exception{
        name = op.getName();
        this.threads = threads;
        this.threadMap = threadMap;
        this.op = op;
...
//        double penalty = baseTime + streamPenalty;
        ...
        penalty = penalty<0.0055 ? 0.0055 : penalty;
...
//        double penalty = baseTime + streamPenalty;
        ...
        if(locality > 0)
            ...
            penalty = baseTime + 0.0001*externalStreams - 0.0001*locality;
