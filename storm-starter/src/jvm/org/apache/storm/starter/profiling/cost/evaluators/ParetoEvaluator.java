 ...
 */
public class ParetoEvaluator extends AbstractProblem {
    ...
    public ParetoEvaluator(GraphParser graph, UserParameters up, SystemParameters sp) throws Exception{
        super(graph.getSpoutMap().size() + graph.getBoltMap().size() + 1, 2, 1);
