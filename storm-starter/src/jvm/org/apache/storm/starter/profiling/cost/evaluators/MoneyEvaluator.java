 ...
 */
public class MoneyEvaluator extends AbstractProblem {
    ...
    public MoneyEvaluator(GraphParser graph, UserParameters up, SystemParameters sp) throws Exception{
    ...
    public void evaluate(Solution solution) {
        ...
        try {
            ...
            solution.setConstraint(0, money <= up.getBudget() ? 0.0 : 1.0);
        }
        catch(Exception e) {
